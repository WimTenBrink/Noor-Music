...
- storyPrompts: A JSON object with "miranda", "annelies", "fannie", "emma", "mirandaAnnelies", "fannieEmma", and "group" fields. Each field contains:
  ...
  - sdxl: A weighted version of the WAN prompt (using (keyword:weight) syntax). SDXL prompts CAN be explicit, detailed, and include nudity or erotic themes. **CRITICAL:** ALWAYS include chest size with cup size in SDXL prompts (e.g., "(flat chest:1.3)", "(AA cup:1.2)").
